...
export type PanelBehavior = "fixed" | "moving";
...
export type PanelLane = { id: string; behavior?: PanelBehavior; size?: PanelSize; align?: PanelAlign; surface?: PanelSurface; blocks: BlockRef[]; };
export type SectionGroup = { id: string; type: "Group"; layout?: GroupLayout; panel?: { mode?: PanelMode; size?: PanelSize; align?: PanelAlign; surface?: PanelSurface; }; panels?: PanelLane[]; motion?: { level: MotionLevel; preset?: "panel" | "media-reveal" | "sticky-story" | "horizontal-rail"; }; blocks?: BlockRef[]; };
