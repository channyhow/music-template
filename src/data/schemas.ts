...
const actionSchema = z.object({
  ...
  intent: z.enum(["navigate", "contact", "call", "directions", "book", "buy", "subscribe", "download", "share"]).optional(),
...
const contentItemSchema: z.ZodTypeAny = z.object({
  ...
  meta: z.array(z.object({ label: z.string(), value: z.string().optional() })).optional(),
...
export const sectionSchema = z.object({
  ...
  layout: z.enum(["text", "statement", "split", "grid", "list", "gallery", "carousel", "media", "media-overlay"]).optional(),
  ...
  motion: z.enum(["none", "reveal", "scene"]).optional(),
